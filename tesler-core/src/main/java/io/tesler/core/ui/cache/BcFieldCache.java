...
@Component
public final class BcFieldCache {

	public final LoadingCache<String, Set<BcField>> bcFields = CacheBuilder
			.newBuilder()
			.build(new BcFieldCacheLoader());

	@Autowired
	private Optional<List<IRequiredFieldsSupplier>> requiredFieldsSuppliers;
