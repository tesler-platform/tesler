			...
			wfVersion(wf, WorkflowVersionService.class),
				...
				wfStep(wfVersion, WorkflowStepService.class),
					...
					wfTransition(wfStep, WorkflowTransitionService.class),
						wfAutoTransition(wfTransition, WorkflowAutoTransitionService.class),
						...
						wfPostFuncGroup(wfTransition, WorkflowTransitionConditionGroupService.class),
							...
							wfTransitionFunc(wfPostFuncGroup, WorkflowPostFunctionService.class),
								wfPostFuncTrigger(wfTransitionFunc, WorkflowPostFunctionTriggerService.class),
									wfPostFuncTriggerWaitStep(wfPostFuncTrigger, WorkflowStepService.class),
									wfPostFuncTriggerTransition(wfPostFuncTrigger, WorkflowTransitionService.class),
