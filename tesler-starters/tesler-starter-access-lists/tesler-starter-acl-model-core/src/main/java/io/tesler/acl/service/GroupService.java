...
public interface GroupService {
	 ...
	 * @return set of identifiers
	 */
	Set<Long> getUserAllGroups(AclUser user);
	 ...
	 * @return подзапрос
	 */
	Subquery<Long> getAllGroupsSubquery(AclUser user, CriteriaQuery<?> cq, CriteriaBuilder cb);
	 ...
	 * @return subquery
	 */
	Subquery<Long> getDirectGroupsSubquery(AclUser user, CriteriaQuery<?> cq, CriteriaBuilder cb);
