...
public class MetaConfigurationProperties {
	...
	@NotNull(message = "Ant path to meta files directory. Supports file: or classpath: prefix. "
	...
	@NotBlank(message = "ant path to widget files from MetaConfigurationProperties.directory")
	private String widgetPath = "/**/*.widget.json";

	@NotBlank(message = "ant path to view files from MetaConfigurationProperties.directory")
	private String viewPath = "/**/*.view.json";

	@NotBlank(message = "ant path to screen files from MetaConfigurationProperties.directory")
