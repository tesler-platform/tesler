...
public class MetaHotReloadService {
	...
	final WidgetUtil widgetUtil;

	final WidgetPropertyUtil widgetPropertyUtil;

	final ViewAndViewWidgetUtil viewAndViewWidgetUtil;

	final ScreenAndNavigationGroupAndNavigationViewUtil screenAndNavigationGroupAndNavigationViewUtil;
