...
import io.tesler.api.task.executors.DelegatingAsyncTaskExecutor;
...
public class SecurityContextAwareAsyncTaskExecutor extends DelegatingAsyncTaskExecutor<AsyncTaskExecutor> {
