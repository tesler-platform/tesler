...
public class DelegatingScheduledExecutorService<T extends ScheduledExecutorService> extends DelegatingExecutorService<T>
		implements ScheduledExecutorService {

	public DelegatingScheduledExecutorService(T delegate) {
		super(delegate);
	}
	...
	@Override
	public <E> ScheduledFuture<E> schedule(Callable<E> callable, long delay, TimeUnit unit) {
